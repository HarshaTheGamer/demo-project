                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        <div class="about-item scrollpoint sp-effect2">
                            <a href="apks/SmaapV1.1.apk" download="SMAAP" target="_blank"><i class="fa fa-download fa-2x"></i>
                            <h3>For Android</h3></a>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="platforms">
                            <a href="apks/SmaapV1.1.apk" download="smaap" target="_blank" class="btn btn-primary inverse scrollpoint sp-effect1">
                                <i class="fa fa-android fa-3x pull-left"></i>
                                <span>Click Here to download SMAAPv1.1 for</span><br>
                                <b>Android</b>
                            </a>
                        </div>
