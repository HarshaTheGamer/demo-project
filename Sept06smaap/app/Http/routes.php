...
Route::get('download', function (Request $request) {
  ...
  echo "<a href='apks/Smaap1.0.3.apk' download='smaap' target='_blank' class='btn btn-primary inverse scrollpoint sp-effect1'>
                                <i class='fa fa-android fa-3x pull-left'></i>
                                <span>Click Here to download SMAAP1.0.3 for</span><br>
                                <b>Android</b>
                            </a>";
});
